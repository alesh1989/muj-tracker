...
}const fmt = (val, currency = "CZK", decimals = 0) => {
  if (val === null || val === undefined || isNaN(val)) return "–";
  const n = Number(val).toLocaleString("cs-CZ", { minimumFractionDigits: decimals, maximumFractionDigits: decimals });
  return `${n} ${currency === "CZK" ? "Kč" : currency}`;
